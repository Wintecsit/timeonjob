	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="{{ url('east_employers/') }}" class="nav-link">Работники с Востока</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
          	<p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-3"><a href="index.html">Главная <i class="ion-ios-arrow-forward"></i></a></span> <span>Работники с Востока</span></p>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
			...
			<form class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="email">Телефон</label>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="quantity">Количество работников</label>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="button" value="Зарегистрироваться" onclick="RegistrationEmployersEast();" class="btn btn-primary  py-2 px-5">
                </div>
              </div>
...
function RegistrationEmployersEast()
{
	$.ajax( "{{ url('main/east_employers_registration') }}", {
		type: "POST",
		data: {
			email  : $('#email').val(),
